...
/**
 * When the form is submitted, fetch is used to send a request using the post
 * method. The request body includes the first name, last name, gpa, and
 * enrollment status of the student. A success or error message is displayed
